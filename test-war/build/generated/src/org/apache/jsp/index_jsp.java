...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                   var test = encodeURI('");
      out.print(requestParameters);
      out.write("');\n");
      out.write("                   $.get('calc',{param:test},function(responseText) {\n");
      out.write("                        var test = decodeURI(responseText);\n");
      out.write("                        $('#welcometext').text(test);         \n");
      out.write("                   });\n");
      out.write("            });\n");
      out.write("        </script>\n");
      out.write("    </head>\n");
